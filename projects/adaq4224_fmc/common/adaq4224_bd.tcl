...
create_bd_port -dir O adaq4224_spi_cs
create_bd_port -dir O adaq4224_spi_sdo
create_bd_port -dir I -from [expr $NUM_OF_SDI-1] -to 0 adaq4224_spi_sdi

create_bd_port -dir I adaq4224_echo_sclk
...
#spi_engine_create "spi_adaq4224" 32         1             1       $NUM_OF_SDI 0          1
...
set hier_spi_engine spi_adaq4224
...
ad_ip_instance axi_dmac axi_adaq4224_dma
ad_ip_parameter axi_adaq4224_dma CONFIG.DMA_TYPE_SRC 1
ad_ip_parameter axi_adaq4224_dma CONFIG.DMA_TYPE_DEST 0
ad_ip_parameter axi_adaq4224_dma CONFIG.CYCLIC 0
ad_ip_parameter axi_adaq4224_dma CONFIG.AXI_SLICE_DEST 1
ad_ip_parameter axi_adaq4224_dma CONFIG.AXI_SLICE_SRC 1
ad_ip_parameter axi_adaq4224_dma CONFIG.DMA_DATA_WIDTH_SRC 64
ad_ip_parameter axi_adaq4224_dma CONFIG.DMA_DATA_WIDTH_DEST 64
...
if {$CAPTURE_ZONE == 1} {
  ...
  switch $CLK_MODE {
    0 {
      ad_connect $hier_spi_engine/echo_sclk adaq4224_echo_sclk
    }
    1 -
    2 {
  ...
  ad_connect adaq4224_busy busy_sync/in_bits
  ...
  switch $CLK_MODE {
    ...
    2 {
      ...
      ad_connect adaq4224_spi_cs data_capture/csn
      ad_connect adaq4224_busy data_capture/echo_sclk
      ad_connect adaq4224_spi_sdi data_capture/data_in
...
ad_connect spi_clk axi_adaq4224_dma/s_axis_aclk
ad_connect adaq4224_ext_clk cnv_generator/ext_clk
...
ad_connect $sys_cpu_resetn axi_adaq4224_dma/m_dest_axi_aresetn

# data path

ad_connect  $hier_spi_engine/${hier_spi_engine}_execution/cs adaq4224_spi_cs
ad_connect  $hier_spi_engine/${hier_spi_engine}_execution/sclk adaq4224_spi_sclk
ad_connect  $hier_spi_engine/${hier_spi_engine}_execution/sdo adaq4224_spi_sdo
ad_connect  $hier_spi_engine/${hier_spi_engine}_execution/sdi adaq4224_spi_sdi
