...
create_bd_port -dir I debug_cs
create_bd_port -dir I -from 2 -to 0 debug_cs_cnt
...
if {$LVDS_CMOS_N == "0"} {
  ad_ip_parameter axi_ad4858 CONFIG.LANE_1_ENABLE 0
  ad_ip_parameter axi_ad4858 CONFIG.LANE_3_ENABLE 0
  ad_ip_parameter axi_ad4858 CONFIG.LANE_5_ENABLE 0
  ad_ip_parameter axi_ad4858 CONFIG.LANE_7_ENABLE 0
...
ad_mem_hp1_interconnect sys_cpu_clk    ad4858_dma/m_dest_axi
