...
set_property  -dict {PACKAGE_PIN  T6    IOSTANDARD LVCMOS18} [get_ports spiad_sck]          ; ##  H32  FMC_HPC0_LA28_N
set_property  -dict {PACKAGE_PIN  U6    IOSTANDARD LVCMOS18} [get_ports spiad_sdi]          ; ##  H35  FMC_HPC0_LA30_N
...
set_property  -dict {PACKAGE_PIN  AA12 IOSTANDARD LVCMOS18} [get_ports fpga_hlsel]         ; ##  G19  FMC_HPC0_LA16_N
...
set_property  -dict {PACKAGE_PIN  Y1   IOSTANDARD LVCMOS18} [get_ports spi_bus1_csn_dat3]  ; ##  G10  FMC_HPC0_LA03_N*

set_property  -dict {PACKAGE_PIN  W1   IOSTANDARD LVCMOS18} [get_ports spi_bus2_sck]       ; ##  D15  FMC_HPC0_LA09_N
set_property  -dict {PACKAGE_PIN  W2   IOSTANDARD LVCMOS18} [get_ports spi_bus2_sdi]       ; ##  D14  FMC_HPC0_LA09_P
set_property  -dict {PACKAGE_PIN  AB8  IOSTANDARD LVCMOS18} [get_ports spi_bus2_sdo]       ; ##  D17  FMC_HPC0_LA13_P
set_property  -dict {PACKAGE_PIN  AC3  IOSTANDARD LVCMOS18} [get_ports spi_bus2_csn_dat1]  ; ##  D12  FMC_HPC0_LA05_N
set_property  -dict {PACKAGE_PIN  P11  IOSTANDARD LVCMOS18} [get_ports spi_bus2_csn_dat2]  ; ##  D20  FMC_HPC0_LA17_P_CC
